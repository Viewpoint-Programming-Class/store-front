...
function StoreHeader ({ cartData }) {
    ...
    return <header>
        ...
        <div className='cart' style={{ position: 'absolute', right: 40, top: 40  }}>
            ...
            {
                totalUnitsInCart > 0
                    ? <div style={{position: 'absolute', top: 0, right: 0, width: 'calc(2 * var(--unit))', height: 'calc(2 * var(--unit))', borderRadius: '50%', backgroundColor: 'var(--color-primary)', color: 'var(--color-white)', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
